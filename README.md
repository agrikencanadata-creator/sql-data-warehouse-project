...
The data architecture for this project follows Medallion Architecture layers:
    **Bronze**
    **Silver** 
    **Gold**
...
2. **Silver Layer**
   - this is to prepare data for analysis
   - this layer includes:
       >> data cleansing,
       >> standardization,
...
Everything is for Free! and is provided by **Baraa Khatib Salkini** as my mentor
